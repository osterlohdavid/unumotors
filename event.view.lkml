view: event {
  sql_table_name: Salesforce.Event ;;
  ...
  dimension_group: activity_date {
    ...
    sql: CAST(${TABLE}.ActivityDateTime AS TIMESTAMP) ;;
  }
  ...
  dimension_group: end_date {
    ...
    sql: CAST(${TABLE}.EndDateTime AS TIMESTAMP) ;;
  }
  ...
  dimension_group: recurrence_start_date {
    ...
    sql: CAST(${TABLE}.RecurrenceStartDateTime AS TIMESTAMP) ;;
  }
  ...
  dimension_group: start_date {
    ...
    sql: CAST(${TABLE}.StartDateTime AS TIMESTAMP) ;;
  }
